...
- [ ] Add event thumbnails, clips, class, confidence, zone, and count. (The private event schema, authenticated ingest/read API, source-segment thumbnail extraction, bounded clip routes, retention cleanup, and motion-gated pipeline now exist; Pi detector wiring and real event verification remain.)
