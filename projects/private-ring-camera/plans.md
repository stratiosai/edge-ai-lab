...
- [ ] Confirm recordings expire automatically after 24 hours. (The exact boundary is now covered by an authenticated end-to-end test: a segment ending one second before the cutoff is removed, while one ending exactly at the cutoff remains. The production archive is currently 23.31 hours old, so the elapsed live-window observation remains open.)
