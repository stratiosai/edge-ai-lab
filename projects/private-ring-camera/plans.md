...
- [ ] Add event thumbnails, clips, class, confidence, zone, and count. (The private event schema, authenticated ingest/read API, and source-segment thumbnail extraction route now exist; clip generation, detector wiring, and real event verification remain.)
